  ...
  return (
    <section ref={ref} className="relative py-24 md:py-32 overflow-hidden bg-dark">
      ...
      <div className="relative max-w-4xl mx-auto px-8 text-center">
        ...
        >
          Kami membantu gereja membangun kehadiran digital yang bermakna — dari desain responsif hingga fitur jadwal ibadah dan donasi online.
        </motion.p>
