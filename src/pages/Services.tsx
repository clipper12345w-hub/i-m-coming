...
const WHATSAPP_URL = 'https://wa.me/62XXXXXXXXXXXX?text=Halo%2C%20saya%20tertarik%20dengan%20layanan%20pembuatan%20website%20gereja';
...
const features = [
  ...
  {
    title: 'Jadwal Ibadah',
    desc: 'Tampilkan jadwal kebaktian, acara gereja, dan kegiatan jemaat secara online.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  {
    title: 'Donasi Online',
    desc: 'Integrasikan fitur persembahan dan donasi digital yang aman dan mudah digunakan.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    ...
    desc: 'Kelola renungan, pengumuman, dan konten gereja dengan mudah tanpa keahlian teknis.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
...
const steps = [
  { num: '01', title: 'Konsultasi', desc: 'Ceritakan kebutuhan gereja Anda. Kami dengarkan dan pahami visi Anda.' },
  { num: '02', title: 'Desain & Pengembangan', desc: 'Tim kami merancang dan membangun website sesuai identitas gereja Anda.' },
  { num: '03', title: 'Launch & Pendampingan', desc: 'Website diluncurkan dan kami dampingi proses adaptasi tim gereja.' },
];
    ...
    <>
      ...
      <section ref={heroRef} className="pt-32 pb-20 md:pt-40 md:pb-28 bg-background">
        <div className="max-w-4xl mx-auto px-8 text-center">
          ...
          >
            Kami Bantu Gereja Anda<br />Hadir Secara Digital
          </motion.h1>
          <motion.p
          ...
          >
            Dari desain yang indah hingga fitur-fitur yang dibutuhkan jemaat — kami membuat website gereja yang memuliakan Tuhan dan melayani sesama.
          </motion.p>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto px-8 text-center">
          ...
          >
            ...
            <p className="font-sans text-base text-muted-foreground mb-10 max-w-lg mx-auto leading-relaxed">
              Hubungi kami melalui WhatsApp untuk konsultasi gratis. Ceritakan kebutuhan gereja Anda dan mari wujudkan bersama.
            </p>
            <a
              href={WHATSAPP_URL}
              target="_blank"
